...
import { ChevronRight, ChevronLeft, Check, User, Bot, Video, MessageSquare, Calendar, ShoppingCart, GraduationCap as Graduation, Trophy, Rocket, BookOpen, Lightbulb, Mic, Sparkles, ArrowRight, Heart, Palette } from 'lucide-react';
        ...
        return (
          ...
          >
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">What's your niche?</h2>
              <p className="text-gray-600 dark:text-gray-400 mt-2">
                We'll customize your portal based on your expertise
              </p>
            </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg flex items-start mt-6">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-300">
                Your niche helps us customize your AI assistant's knowledge, site templates, and service offerings.
              </p>
            </div>
          </motion.div>
        );
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
              <div className="bg-primary/10 p-4 flex items-center border-b border-gray-200 dark:border-gray-700">
                ...
                <span className="font-medium text-gray-900 dark:text-white">
                  your-creator-portal.boltdesk.ai
                </span>
              </div>
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white">
                      Your {nicheOptions.find(n => n.id === selectedNiche)?.label || 'Creator'} Portal
                    </h3>
